...
const CreateCustomerForm = ({ customers, backendURL, refreshCustomers, onClose }) => {
        ...
        <Container className="p-0">
            <div className="form-container p-4 mb-4 border rounded bg-light">
                ...
                <div className="position-relative p-3 border-bottom">
                    <h3 className="text-center m-0">Enter Customer Details</h3>
                ...
                <Form>
                    ...
                    <Form.Group className="mb-3" controlId="create_contact_email">
                        ...
                        <Form.Control type="boolean" className="text-center"/>
                    </Form.Group>
