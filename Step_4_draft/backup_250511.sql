...
CREATE TABLE `RepairReports` (
  ...
  CONSTRAINT `RepairReports_ibfk_1` FOREIGN KEY (`bikeID`) REFERENCES `Bikes` (`bikeID`),
  CONSTRAINT `RepairReports_ibfk_2` FOREIGN KEY (`personnelID`) REFERENCES `StorePersonnel` (`personnelID`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SalesReports` (
  ...
  CONSTRAINT `SalesReports_ibfk_1` FOREIGN KEY (`customerID`) REFERENCES `Customers` (`customerID`) ON DELETE CASCADE,
...
CREATE TABLE `StorePersonnel` (
  ...
  KEY `contactID` (`contactID`),
  CONSTRAINT `StorePersonnel_ibfk_1` FOREIGN KEY (`contactID`) REFERENCES `Contacts` (`contactID`) ON DELETE CASCADE
...
-- Dump completed on 2025-05-11 10:22:07
